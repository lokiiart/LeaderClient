...
export default class ParkStatusRow extends Component{
  render() {
    ...
    return(
      <Row style={rowStyle}>
        ...
        <CheckableCell style={styles.cell} width={1}
                       isChecked = {true}
                          ...
                          return(
                            <View>
                              <Text style={{textAlign: 'center', color:
                                Theme.darkTextColor }}>{item.month}月</Text>
                            </View>
                          )
                        }}
                       renderIsNotChecked={() => {
        ...
        <Cell style={styles.cell} width={2} textStyle={{ textAlign: 'center', color: Theme.darkTextColor }}>
          {item.outputThisMonth}
        </Cell>
        <Cell style={styles.cell} width={2} textStyle={{ textAlign: 'center', color: Theme.darkTextColor }}>
          {item.speedUpThanLastYear}
        </Cell>
        <Cell style={styles.cell} width={2} textStyle={{ textAlign: 'center', color: Theme.darkTextColor }}>
          {item.industrySpeedThisMonth}
        </Cell>
        <Cell style={styles.cell} width={2} textStyle={{ textAlign: 'center', color: Theme.darkTextColor }}>
          {item.newOutputThisMonth}
        </Cell>
        <Cell style={styles.cell} width={2} textStyle={{ textAlign: 'center', color: Theme.darkTextColor }}>
          {item.newSpeedUpThanLastYear}
        </Cell>
      </Row>
    )
  }
